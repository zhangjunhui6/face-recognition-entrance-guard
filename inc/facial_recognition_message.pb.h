...
extern CtrlInfoDefaultTypeInternal _CtrlInfo_default_instance_;
class FaceFeature;
...
template<> ::ascend::presenter::facial_recognition::CtrlInfo* Arena::CreateMaybeMessage<::ascend::presenter::facial_recognition::CtrlInfo>(Arena*);
...
class CtrlInfo :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ascend.presenter.facial_recognition.CtrlInfo) */ {
 public:
  CtrlInfo();
  virtual ~CtrlInfo();

  CtrlInfo(const CtrlInfo& from);
  CtrlInfo(CtrlInfo&& from) noexcept
    : CtrlInfo() {
    *this = ::std::move(from);
  }

  inline CtrlInfo& operator=(const CtrlInfo& from) {
    CopyFrom(from);
    return *this;
  }
  inline CtrlInfo& operator=(CtrlInfo&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const CtrlInfo& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const CtrlInfo* internal_default_instance() {
    return reinterpret_cast<const CtrlInfo*>(
               &_CtrlInfo_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    2;

  void Swap(CtrlInfo* other);
  friend void swap(CtrlInfo& a, CtrlInfo& b) {
    a.Swap(&b);
  }

  // implements Message ----------------------------------------------

  inline CtrlInfo* New() const final {
    return CreateMaybeMessage<CtrlInfo>(nullptr);
  }

  CtrlInfo* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<CtrlInfo>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const CtrlInfo& from);
  void MergeFrom(const CtrlInfo& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(CtrlInfo* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "ascend.presenter.facial_recognition.CtrlInfo";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  // uint32 buzzer = 1;
  void clear_buzzer();
  static const int kBuzzerFieldNumber = 1;
  ::PROTOBUF_NAMESPACE_ID::uint32 buzzer() const;
  void set_buzzer(::PROTOBUF_NAMESPACE_ID::uint32 value);
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::InternalMetadataWithArena _internal_metadata_;
  ::PROTOBUF_NAMESPACE_ID::uint32 buzzer_;
...
class FaceFeature :
 ...
 public:
  ...
  // float alive_score = 2;
  void clear_alive_score();
  static const int kAliveScoreFieldNumber = 2;
  float alive_score() const;
  void set_alive_score(float value);
...
// uint32 buzzer = 1;
inline void CtrlInfo::clear_buzzer() {
  buzzer_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 CtrlInfo::buzzer() const {
  // @@protoc_insertion_point(field_get:ascend.presenter.facial_recognition.CtrlInfo.buzzer)
  return buzzer_;
}
inline void CtrlInfo::set_buzzer(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  buzzer_ = value;
  // @@protoc_insertion_point(field_set:ascend.presenter.facial_recognition.CtrlInfo.buzzer)
}

// uint32 open = 2;
inline void CtrlInfo::clear_open() {
  open_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 CtrlInfo::open() const {
  // @@protoc_insertion_point(field_get:ascend.presenter.facial_recognition.CtrlInfo.open)
  return open_;
}
inline void CtrlInfo::set_open(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  open_ = value;
  // @@protoc_insertion_point(field_set:ascend.presenter.facial_recognition.CtrlInfo.open)
}
...
// float alive_score = 2;
inline void FaceFeature::clear_alive_score() {
  alive_score_ = 0;
}
inline float FaceFeature::alive_score() const {
  // @@protoc_insertion_point(field_get:ascend.presenter.facial_recognition.FaceFeature.alive_score)
  return alive_score_;
}
inline void FaceFeature::set_alive_score(float value) {
  
  alive_score_ = value;
  // @@protoc_insertion_point(field_set:ascend.presenter.facial_recognition.FaceFeature.alive_score)
}
...
// float temp = 3;
inline void FrameInfo::clear_temp() {
  temp_ = 0;
}
inline float FrameInfo::temp() const {
  // @@protoc_insertion_point(field_get:ascend.presenter.facial_recognition.FrameInfo.temp)
  return temp_;
}
inline void FrameInfo::set_temp(float value) {
  
  temp_ = value;
  // @@protoc_insertion_point(field_set:ascend.presenter.facial_recognition.FrameInfo.temp)
}
