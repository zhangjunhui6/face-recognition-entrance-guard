...
class CtrlInfoDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<CtrlInfo> _instance;
} _CtrlInfo_default_instance_;
...
static void InitDefaultsscc_info_CtrlInfo_facial_5frecognition_5fmessage_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::ascend::presenter::facial_recognition::_CtrlInfo_default_instance_;
    new (ptr) ::ascend::presenter::facial_recognition::CtrlInfo();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::ascend::presenter::facial_recognition::CtrlInfo::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_CtrlInfo_facial_5frecognition_5fmessage_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsscc_info_CtrlInfo_facial_5frecognition_5fmessage_2eproto}, {}};
...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_facial_5frecognition_5fmessage_2eproto[8];
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_facial_5frecognition_5fmessage_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::ascend::presenter::facial_recognition::CtrlInfo, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::ascend::presenter::facial_recognition::CtrlInfo, buzzer_),
  PROTOBUF_FIELD_OFFSET(::ascend::presenter::facial_recognition::CtrlInfo, open_),
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::ascend::presenter::facial_recognition::FaceFeature, alive_score_),
  ...
  PROTOBUF_FIELD_OFFSET(::ascend::presenter::facial_recognition::FrameInfo, temp_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::ascend::presenter::facial_recognition::RegisterApp)},
  { 7, -1, sizeof(::ascend::presenter::facial_recognition::CommonResponse)},
  { 14, -1, sizeof(::ascend::presenter::facial_recognition::CtrlInfo)},
  { 21, -1, sizeof(::ascend::presenter::facial_recognition::FaceInfo)},
  { 28, -1, sizeof(::ascend::presenter::facial_recognition::Box)},
  { 37, -1, sizeof(::ascend::presenter::facial_recognition::FaceFeature)},
  { 45, -1, sizeof(::ascend::presenter::facial_recognition::FaceResult)},
  { 53, -1, sizeof(::ascend::presenter::facial_recognition::FrameInfo)},
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::ascend::presenter::facial_recognition::_CtrlInfo_default_instance_),
...
const char descriptor_table_protodef_facial_5frecognition_5fmessage_2eproto[] =
  ...
  "onResponse\022;\n\003ret\030\001 \001(\0162..ascend.present"
  "er.facial_recognition.ErrorCode\022\017\n\007messa"
  "ge\030\002 \001(\t\"(\n\010CtrlInfo\022\016\n\006buzzer\030\001 \001(\r\022\014\n\004"
  "open\030\002 \001(\r\"%\n\010FaceInfo\022\n\n\002id\030\001 \001(\t\022\r\n\005im"
  "age\030\002 \001(\014\"=\n\003Box\022\014\n\004lt_x\030\001 \001(\r\022\014\n\004lt_y\030\002"
  " \001(\r\022\014\n\004rb_x\030\003 \001(\r\022\014\n\004rb_y\030\004 \001(\r\"i\n\013Face"
  "Feature\0225\n\003box\030\001 \001(\0132(.ascend.presenter."
  "facial_recognition.Box\022\023\n\013alive_score\030\002 "
  "\001(\002\022\016\n\006vector\030\003 \003(\002\"\242\001\n\nFaceResult\022\n\n\002id"
  "\030\001 \001(\t\022E\n\010response\030\002 \001(\01323.ascend.presen"
  "ter.facial_recognition.CommonResponse\022A\n"
  "\007feature\030\003 \003(\01320.ascend.presenter.facial"
  "_recognition.FaceFeature\"k\n\tFrameInfo\022\r\n"
  "\005image\030\001 \001(\014\022A\n\007feature\030\002 \003(\01320.ascend.p"
  "resenter.facial_recognition.FaceFeature\022"
  "\014\n\004temp\030\003 \001(\002*\177\n\tErrorCode\022\016\n\nkErrorNone"
  "\020\000\022\032\n\026kErrorAppRegisterExist\020\001\022\031\n\025kError"
  "AppRegisterType\020\002\022\032\n\026kErrorAppRegisterLi"
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_facial_5frecognition_5fmessage_2eproto_sccs[8] = {
  &scc_info_Box_facial_5frecognition_5fmessage_2eproto.base,
  &scc_info_CommonResponse_facial_5frecognition_5fmessage_2eproto.base,
  &scc_info_CtrlInfo_facial_5frecognition_5fmessage_2eproto.base,
  &scc_info_FaceFeature_facial_5frecognition_5fmessage_2eproto.base,
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_facial_5frecognition_5fmessage_2eproto = {
  &descriptor_table_facial_5frecognition_5fmessage_2eproto_initialized, descriptor_table_protodef_facial_5frecognition_5fmessage_2eproto, "facial_recognition_message.proto", 870,
  &descriptor_table_facial_5frecognition_5fmessage_2eproto_once, descriptor_table_facial_5frecognition_5fmessage_2eproto_sccs, descriptor_table_facial_5frecognition_5fmessage_2eproto_deps, 8, 0,
  schemas, file_default_instances, TableStruct_facial_5frecognition_5fmessage_2eproto::offsets,
  file_level_metadata_facial_5frecognition_5fmessage_2eproto, 8, file_level_enum_descriptors_facial_5frecognition_5fmessage_2eproto, file_level_service_descriptors_facial_5frecognition_5fmessage_2eproto,
};
...
void CtrlInfo::InitAsDefaultInstance() {
}
class CtrlInfo::HasBitSetters {
 public:
};

#if !defined(_MSC_VER) || _MSC_VER >= 1900
const int CtrlInfo::kBuzzerFieldNumber;
const int CtrlInfo::kOpenFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900

CtrlInfo::CtrlInfo()
  : ::PROTOBUF_NAMESPACE_ID::Message(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:ascend.presenter.facial_recognition.CtrlInfo)
}
CtrlInfo::CtrlInfo(const CtrlInfo& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
      _internal_metadata_(nullptr) {
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::memcpy(&buzzer_, &from.buzzer_,
    static_cast<size_t>(reinterpret_cast<char*>(&open_) -
    reinterpret_cast<char*>(&buzzer_)) + sizeof(open_));
  // @@protoc_insertion_point(copy_constructor:ascend.presenter.facial_recognition.CtrlInfo)
}

void CtrlInfo::SharedCtor() {
  ::memset(&buzzer_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&open_) -
      reinterpret_cast<char*>(&buzzer_)) + sizeof(open_));
}

CtrlInfo::~CtrlInfo() {
  // @@protoc_insertion_point(destructor:ascend.presenter.facial_recognition.CtrlInfo)
  SharedDtor();
}

void CtrlInfo::SharedDtor() {
}

void CtrlInfo::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const CtrlInfo& CtrlInfo::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_CtrlInfo_facial_5frecognition_5fmessage_2eproto.base);
  return *internal_default_instance();
}


void CtrlInfo::Clear() {
// @@protoc_insertion_point(message_clear_start:ascend.presenter.facial_recognition.CtrlInfo)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
#if GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER
const char* CtrlInfo::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 8)) {
          buzzer_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // uint32 open = 2;
...
#else  // GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER
bool CtrlInfo::MergePartialFromCodedStream(
    ::PROTOBUF_NAMESPACE_ID::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!PROTOBUF_PREDICT_TRUE(EXPRESSION)) goto failure
  ::PROTOBUF_NAMESPACE_ID::uint32 tag;
  // @@protoc_insertion_point(parse_start:ascend.presenter.facial_recognition.CtrlInfo)
  for (;;) {
    ::std::pair<::PROTOBUF_NAMESPACE_ID::uint32, bool> p = input->ReadTagWithCutoffNoLastTag(127u);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:ascend.presenter.facial_recognition.CtrlInfo)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:ascend.presenter.facial_recognition.CtrlInfo)
  return false;
#undef DO_
}
#endif  // GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER

void CtrlInfo::SerializeWithCachedSizes(
    ::PROTOBUF_NAMESPACE_ID::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:ascend.presenter.facial_recognition.CtrlInfo)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;

  // uint32 buzzer = 1;
  if (this->buzzer() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32(1, this->buzzer(), output);
  }

  // uint32 open = 2;
  if (this->open() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32(2, this->open(), output);
  }
  ...
  // @@protoc_insertion_point(serialize_end:ascend.presenter.facial_recognition.CtrlInfo)
}

::PROTOBUF_NAMESPACE_ID::uint8* CtrlInfo::InternalSerializeWithCachedSizesToArray(
    ::PROTOBUF_NAMESPACE_ID::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:ascend.presenter.facial_recognition.CtrlInfo)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;

  // uint32 buzzer = 1;
  if (this->buzzer() != 0) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32ToArray(1, this->buzzer(), target);
  }

  // uint32 open = 2;
  if (this->open() != 0) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32ToArray(2, this->open(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:ascend.presenter.facial_recognition.CtrlInfo)
  return target;
}

size_t CtrlInfo::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:ascend.presenter.facial_recognition.CtrlInfo)
  size_t total_size = 0;
...
void CtrlInfo::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:ascend.presenter.facial_recognition.CtrlInfo)
  GOOGLE_DCHECK_NE(&from, this);
  const CtrlInfo* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<CtrlInfo>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:ascend.presenter.facial_recognition.CtrlInfo)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:ascend.presenter.facial_recognition.CtrlInfo)
    MergeFrom(*source);
  }
}

void CtrlInfo::MergeFrom(const CtrlInfo& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:ascend.presenter.facial_recognition.CtrlInfo)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void CtrlInfo::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:ascend.presenter.facial_recognition.CtrlInfo)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void CtrlInfo::CopyFrom(const CtrlInfo& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:ascend.presenter.facial_recognition.CtrlInfo)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool CtrlInfo::IsInitialized() const {
  return true;
}

void CtrlInfo::Swap(CtrlInfo* other) {
  if (other == this) return;
  InternalSwap(other);
}
void CtrlInfo::InternalSwap(CtrlInfo* other) {
  using std::swap;
  _internal_metadata_.Swap(&other->_internal_metadata_);
  swap(buzzer_, other->buzzer_);
  swap(open_, other->open_);
}

::PROTOBUF_NAMESPACE_ID::Metadata CtrlInfo::GetMetadata() const {
  return GetMetadataStatic();
}
...
const int FaceFeature::kAliveScoreFieldNumber;
...
FaceFeature::FaceFeature(const FaceFeature& from)
  ...
  alive_score_ = from.alive_score_;
...
void FaceFeature::SharedCtor() {
  ...
  ::memset(&box_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&alive_score_) -
      reinterpret_cast<char*>(&box_)) + sizeof(alive_score_));
}
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 21)) {
          alive_score_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<float>(ptr);
          ptr += sizeof(float);
        } else goto handle_unusual;
        continue;
...
void FaceFeature::SerializeWithCachedSizes(
  ...
  // float alive_score = 2;
  if (!(this->alive_score() <= 0 && this->alive_score() >= 0)) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteFloat(2, this->alive_score(), output);
  }
...
::PROTOBUF_NAMESPACE_ID::uint8* FaceFeature::InternalSerializeWithCachedSizesToArray(
  ...
  // float alive_score = 2;
  if (!(this->alive_score() <= 0 && this->alive_score() >= 0)) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteFloatToArray(2, this->alive_score(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:ascend.presenter.facial_recognition.FaceFeature)
  ...
  if (!(from.alive_score() <= 0 && from.alive_score() >= 0)) {
    set_alive_score(from.alive_score());
  }
}
...
void FaceFeature::InternalSwap(FaceFeature* other) {
  ...
  swap(alive_score_, other->alive_score_);
}
...
const int FrameInfo::kTempFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900
...
void FrameInfo::SerializeWithCachedSizes(
  ...
  if (!(this->temp() <= 0 && this->temp() >= 0)) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteFloat(3, this->temp(), output);
  }
...
::PROTOBUF_NAMESPACE_ID::uint8* FrameInfo::InternalSerializeWithCachedSizesToArray(
  ...
  // float temp = 3;
  if (!(this->temp() <= 0 && this->temp() >= 0)) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteFloatToArray(3, this->temp(), target);
  }
...
template<> PROTOBUF_NOINLINE ::ascend::presenter::facial_recognition::CtrlInfo* Arena::CreateMaybeMessage< ::ascend::presenter::facial_recognition::CtrlInfo >(Arena* arena) {
  return Arena::CreateInternal< ::ascend::presenter::facial_recognition::CtrlInfo >(arena);
}
